...
import ga.findparty.findparty.profile.RecommendUserListActivity;
 ...
 */
public class RecommendCourseUserListCustomAdapter extends RecyclerView.Adapter<RecommendCourseUserListCustomAdapter.ViewHolder> {

    // UI
    private Context context;
    private RecommendCourseUserActivity activity;
    ...
    // 생성자
    public RecommendCourseUserListCustomAdapter(Context context, ArrayList<HashMap<String, String>> list, RecyclerView recyclerView, OnAdapterSupport listener, Activity activity) {
        this.context = context;
        this.list = list;
        this.onAdapterSupport = listener;
        this.activity = (RecommendCourseUserActivity)activity;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.course_user_list_custom_item,null);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.tv_interest.setText(item.get("interest"));
    ...
    public final static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            super(v);
            root = (RelativeLayout)v.findViewById(R.id.rl_profile);
