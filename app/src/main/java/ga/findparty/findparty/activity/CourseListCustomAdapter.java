 ...
 */
public class CourseListCustomAdapter extends RecyclerView.Adapter<CourseListCustomAdapter.ViewHolder> {
    ...
    // 생성자
    public CourseListCustomAdapter(Context context, ArrayList<HashMap<String, String>> list, RecyclerView recyclerView, OnAdapterSupport listener, Activity activity) {
